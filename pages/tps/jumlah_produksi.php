...
<body>
    ...
    <div id="wrapper">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
								<a href="tambah_produksi.php">Tambah</a>
		...
		<?php
		$sql = "select * from produksi order by id_produksi";
		...
		while($row = mysql_fetch_assoc($daftar))
		{
			?>
				<tr>
					...
					<td><a href="proses_hapus_produksi.php?id=<?php echo $row['id_produksi']?>">Hapus</a></td>
					<td><a href="update_produksi.php?id=<?php echo $row['id_produksi']?>">Update</a></td>
				</tr>
