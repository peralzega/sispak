                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							...
							<div class="dataTable_wrapper">
								...
								<a href="tambah_penjualan.php">Tambah</a>
                                    <thead>
                                        <tr>
                                            <td>ID</td>
                                            <td>Tanggal</td>
		...
		while($row = mysql_fetch_assoc($daftar))
		{
			?>
				<tr>
					...
					<td><a href="proses_hapus_penjualan.php?id=<?php echo $row['id_penjualan']?>">Hapus</a></td>
					<td><a href="update_penjualan.php?id=<?php echo $row['id_penjualan']?>">Update</a></td>
				</tr>
