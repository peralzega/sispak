                    ...
                    <div class="panel panel-green">
                        ...
                        <a>
							...
							<td style="padding:10px">
									<a href="destroy.php"><button style="width:120px" type="button" class="btn btn-outline btn-success btn-block">Reset</button></a>
							</td>
								<?php } else {
											if ($_SESSION['hitung']==1) {
								?>
							<td style="padding:10px">
								<button style="width:120px" form="form_tanya" type="submit" class="btn btn-outline btn-success btn-block">Submit</button>
							</td>	
								<?php
											} else {
								 ?>
							...
							<td style="padding:10px">
									<a href="back.php"><button style="width:120px" type="button" class="btn btn-outline btn-success btn-block">Back</button></a>
                            </td>     
								 <?php }}?>
                            </div>
                        </a>
